...
declare const toMessageParams: (api: ApiBase<'promise'>, abiParams: AbiParam[], userParams?: Record<string, unknown>) => unknown[];
...
declare const planckToDecimal: (amount: undefined | string | number | number[] | BN | Uint8Array | Buffer, options: DecimalOptions) => number | undefined;
interface PlanckToDecimalOptions {
    significantFigures?: number;
    symbol?: string;
}
declare const planckToDecimalFormatted: (amount: undefined | string | number | number[] | BN | Uint8Array | Buffer, options: PlanckToDecimalOptions & DecimalOptions) => string | undefined;
declare const decimalToPlanck: (amount: number, options: DecimalOptions | undefined) => BigInt | undefined;
